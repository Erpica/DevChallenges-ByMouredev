...
class Tournamet:
    ...
    def start(self):
        ...
        while len(self.fighters) > 1:
            ...
            round += 1
        print(f"El ganador del torneo es {self.fighters[0].name}")
...
fighters = [
    Fighter("Goku", 90, 90, 90),
    Fighter("Krilin", 50, 70, 70),
    Fighter("Piccolo", 70, 80, 90),
    Fighter("Cell", 100, 95, 95)    
]

tournamet = Tournamet(fighters)
tournamet.start()
