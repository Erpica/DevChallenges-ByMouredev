...
def select_winners(data: list):
    if len(data) < 3:
        raise ValueError("El número de elementos debe ser mínimo tres.")
...
try:
    ...
    print("El programa se ha detenido de forma inesperada porque no hay candidatos suficientes para los tres premios.")